...
from . import qr, ocr, ai

# Configure logging
logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

def process_certificate_verification(
    db: Session, 
    file_path: str, 
    student_id: int
    ...
    try:
        ...
        qr_start = time.time()
        qr_detected, qr_data = qr.detect_and_process_qr(file_path)
...
def detect_and_process_qr(file_path: str) -> Tuple[bool, str | None]:
